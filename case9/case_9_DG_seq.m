...
% branch 8
Z58s=0.052912875000000+0.039472500000000*j;
Z5_8 = [Z58s;Z58s;3*Z58s];
Z5_8s = A1*(diag([Z5_8(1,1),Z5_8(2,1),Z5_8(3,1)],0))*inv(A1);
Y5_8 = inv(Z5_8s);
gsh58=[0,0;0,0];
bsh58=[0,0;0,0];
Ysh58=gsh58+bsh58*j;
Y58_11=[Y5_8(1,1) Y5_8(1,2);Y5_8(2,1) Y5_8(2,2)]+Ysh58;
Y58_12=-[Y5_8(1,1) Y5_8(1,2);Y5_8(2,1) Y5_8(2,2)];
Y58_21=-[Y5_8(1,1) Y5_8(1,2);Y5_8(2,1) Y5_8(2,2)];
Y58_22=[Y5_8(1,1) Y5_8(1,2);Y5_8(2,1) Y5_8(2,2)]+Ysh58;

% branch 9
Z49s=0.052912875000000+0.039472500000000*j;
Z4_9 = [Z49s;Z49s;3*Z49s];
Z4_9s = A1*(diag([Z4_9(1,1),Z4_9(2,1),Z4_9(3,1)],0))*inv(A1);
Y4_9 = inv(Z4_9s);
gsh49=0;
bsh49=0;
Ysh49=gsh49+bsh49*j;
Y49_11=Y4_9(1,1)+Ysh49;
Y49_12=-Y4_9(1,1);
Y49_21=-Y4_9(1,1);
Y49_22=Y4_9(1,1)+Ysh49;
...
cvx_begin
    ...
    variables pf(24) qf(24) pt(24) qt(24)
    variables pG(6) qG(6)
    variable v(21,21) hermitian
...
% bus 4
pt(7)==pf(13)+pL4(1)+pf(24);
pt(8)==pf(14)+pL4(2);
pt(9)==pf(15)+pL4(3);

qt(7)==qf(13)+qL4(1)+qf(24);
qt(8)==qf(14)+qL4(2);
qt(9)==qf(15)+qL4(3);

% bus 5
pG(4)==-pt(10)-pt(13)+pf(22);
pG(5)==-pt(11)-pt(14)+pf(23);
pG(6)==-pt(12)-pt(15);

qG(4)==-qt(10)-qt(13)+qf(22);
qG(5)==-qt(11)-qt(14)+qf(23);
qG(6)==-qt(12)-qt(15);
...
pDG(1)+pDG(2)+pDG(3)==Pdg;
qDG(1)+qDG(2)+qDG(3)==Qdg;
...
% branch 8
pf(22) + qf(22)*j == conj(Y58_11(1,1))*v(13,13)+conj(Y58_11(1,2))*v(13,14)+conj(Y58_12(1,1))*v(13,19)+conj(Y58_12(1,2))*v(13,20);
pf(23) + qf(23)*j == conj(Y58_11(2,1))*v(14,13)+conj(Y58_11(2,2))*v(14,14)+conj(Y58_12(2,1))*v(14,19)+conj(Y58_12(2,2))*v(14,20);

-pt(22,1) - qt(22,1)*j == conj(Y58_21(1,1))*v(19,13)+conj(Y58_21(1,2))*v(19,14)+conj(Y58_22(1,1))*v(19,19)+conj(Y58_22(1,2))*v(19,20);
-pt(23,1) - qt(23,1)*j == conj(Y58_21(2,1))*v(20,13)+conj(Y58_21(2,2))*v(20,14)+conj(Y58_22(2,1))*v(20,19)+conj(Y58_22(2,2))*v(20,20);

% branch 9
pf(24) + qf(24)*j == conj(Y49_11(1,1))*v(10,10)+conj(Y49_12(1,1))*v(10,21);
-pt(24,1) - qt(24,1)*j == conj(Y49_21(1,1))*v(21,10)+conj(Y49_22(1,1))*v(21,21);
...
[su(1) pf(24) + 1j*qf(24); pf(24) - 1j*qf(24) su(1)] == hermitian_semidefinite(2)
[su(1) pt(24) + 1j*qt(24); pt(24) - 1j*qt(24) su(1)] == hermitian_semidefinite(2)
...
angle8A=angle5A+atan2(imag(v(19,13)),real(v(19,13)));
angle8B=angle5B+atan2(imag(v(20,14)),real(v(20,14)));

angle9A=angle4A+atan2(imag(v(21,10)),real(v(21,10)));
Asdp=[angle1A;angle1B;angle1C;angle2A;angle2B;angle2C;angle3A;angle3B;angle3C;angle4A;angle4B;angle4C;angle5A;angle5B;angle5C;angle6A;angle6B;angle6C;angle7A;angle7B;angle7C;angle8A;angle8B;angle9A]
